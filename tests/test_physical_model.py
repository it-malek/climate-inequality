"""Tests for src.physical_model -- the physical driver estimator.

Covers the Prais-Winsten whitener, the closed-form NIG posterior + evidence-lambda,
recovery of known synthetic parameters, near-unit-root stationarity, out-of-sample
hindcast coverage, deterministic byte-stable artifacts, the trajectory/summary
schemas, and a statsmodels cross-check of the AR(1) GLS fit.
"""
