"""Tests for src.coupling -- the deterministic projection comparator.

Covers closure over the registered projections, the closed operator set,
byte-stable schema-stable outputs, and a summary that carries only the
permitted fields (no interpretation).
"""
