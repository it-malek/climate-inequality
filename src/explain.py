...
2. **Country level**: does the +0.029 deg C/decade-per-10x-emissions
...
# ---------------------------------------------------------------------
# 3. Geo + data integrity preflight (gates the city and country models)
# ---------------------------------------------------------------------

# (City, Country) pairs spot-checked by print_city_sanity_checks.
# The Iceland entry keeps the accented spelling used in city_trends.parquet.
...
# Per-spec partial-R^2 groupings. "interaction" groups the Koeppen
