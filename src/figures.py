...
def render_city_anomaly_series(
    ...
    Args:
        ...
        slope: Fitted trend in deg C/decade.
...
def render_residual_map(
    ...
    Args:
        ...
        value_col: Residual column to color by (deg C).
...
def render_validation_series(
    ...
    Args:
        ...
        forecast_start: First out-of-sample month, drawn as a vertical
            cutoff line.
        date_col: Date column name.
        observed_col: Observed global-mean anomaly column (deg C).
        predicted_col: Extrapolated-prediction column (deg C).
        rolling_months: Window for the centered rolling mean.
        title: Figure title.
...
def render_partial_effect_scatter(
    ...
    """Scatter of warming trend vs absolute latitude, colored by Koeppen class.
