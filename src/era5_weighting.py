...
- absolute Kelvin rather than monthly anomalies (a historical preprocessing
  sensitivity; only a constant unit offset is irrelevant to a slope);
...
def era5_world_land_mean(nc_path=ERA5_GRID_PATH, gpw_path=GPW_PATH, **kwargs) -> float:
    ...
    Should land near Berkeley Earth's ~0.19 deg C/decade global-land trend. Accepts
