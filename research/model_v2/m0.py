"""M0: the frozen V1 decomposition model, refit exactly as ``src.decomposition`` fits it.
...
(``app/data/decomposition_summary.json`` and ``stability_summary.json`` at commit
a6733cb) and :func:`verify_against_bundle` checks a refit against it.
"""
