"""M0 residual diagnostics: descriptive statistics of the V1 residual.
...
* ``m0_residual_diagnostics.json`` -- the numeric diagnostics quoted in ``RESIDUAL_DIAGNOSTICS.md``.
"""
