"""Conditional M2 robustness arms, or their verified non-execution.

Runs only from a committed, pushed, digest-verified primary M2 result that records predictive support
(promoted or not). Two arms, each refitting M0* and M2 in both representations under every protocol:

* ``m1a_area_geography``   - the M1a area measurements replace the five station geography features;
