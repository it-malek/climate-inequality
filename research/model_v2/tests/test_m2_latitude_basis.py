"""M2 latitude functional form: the fixed natural cubic basis and the hemisphere interaction.
...
def test_hemisphere_labels_outside_the_n_s_coding_raise(labels):
