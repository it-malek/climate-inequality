"""Evaluate the candidate spatial cross-validation designs on the fixed M0.
...
def fold_membership(table: pd.DataFrame, designs: dict[str, dict]) -> pd.DataFrame:
    """Country -> fold id for every candidate (for inspection and for the primary protocol)."""
